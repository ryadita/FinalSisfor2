                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="<?php echo base_url('index.php/admin/update'); ?>" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="No_telp" id="email_address" class="form-control" placeholder="masukkan nomor telepon" value="<?php echo $detail->No_telp; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="Tanggal_lahir" id="email_address" class="form-control" placeholder="masukkan tanggal lahir" value="<?php echo $detail->Tanggal_lahir; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="Universitas" id="email_address" class="form-control" placeholder="masukkan instansi / universitas" value="<?php echo $detail->Universitas; ?>">
                                    </div>
                                </div>
                                <br>
